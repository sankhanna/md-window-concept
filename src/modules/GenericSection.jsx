...
// A lightweight placeholder for Account Hub sections that don't yet have a full
// build-out (Production Setup, Petty Cash, Cost Report, Period Close, Vendors).
// It titles itself from the module key so one component serves them all.
      ...
      <div className="mod-scroll">
        <div className="generic">
          ...
          <p className="generic__note">
            This Account Hub section opens as its own window. Content for
